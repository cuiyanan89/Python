...
#y为纵向分割线
    ...
    open_choice_list[0] = random.randint(width_lift+1,y-1,2)
    open_choice_list[1] = random.randint(height_up+1,x-1,2)
    open_choice_list[2] = random.randint(y+1,width_right-1,2)
    open_choice_list[3] = random.randint(x+1,heitht_down-1,2)
    if open_list[0]==1:
